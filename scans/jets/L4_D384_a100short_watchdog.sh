...
# Or one arm:
#   ETA0=0.01 TARGET=100000 SLEEP_SEC=900 nohup bash scans/jets/L4_D384_a100short_watchdog.sh &
#
set -uo pipefail
...
SLURM=/home/jdezoort/coupled-particle-edge-networks/scans/jets/scaling_law_L4_D384_b128_s100k_a100short.slurm
LOG_CANDIDATES=(
  "$ROOT/logs/watchdog_L4D384_a100short_e${ETA_TAG}.log"
  "${HOME}/.cache/jc_L4D384_watchdogs/watchdog_L4D384_a100short_e${ETA_TAG}.log"
)
